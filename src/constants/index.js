...
export const clients = [
  {
    ...
    icon: franklin,
    description:
      "Created a strategic brand partnership between Celsius and a student-run festival company that resulted in a 15,000 dollar donation from Celsius to aid in event costs and a 10,000 dollar product donation for festival attendees and staff.",
  },
  {
    title: "Jola House",
    type: "Consulting",
    icon: jola,
    description:
      "Successfully sourced and onboarded a dedicated student social media intern, enhancing Jola House's online presence and engagement. Crafted a comprehensive launch plan for their pioneering college ambassador program, harnessing the power of student networks to amplify their impact. ",
  },
  {
    ...
    icon: kwench,
    description:
      "Established a Tik tok and Instagram account for the brand. Produced and published 80 engaging Instagram reels within six months. Grew Instagram page from to 400 followers. Best reel garnered 853 likes and 6000 views. Helped with grand opening planning, menu design, and more",
  },
  {
...
export const services = [
  {
    ...
    moreInfo:
      "Select a one-hour appointment, either in-person or virtual. Your business can designate one area to focus on, such as refining your social media strategy, optimizing email communications, developing in-store promotion tactics, creating a social media calendar, or creating an ambassador program. Our team of consultants will tackle your business's challenges and consolidate feedback from all of us into a plan by the end of that business month.    ",
  },
  {
