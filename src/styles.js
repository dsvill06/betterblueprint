const styles = {
    ...
    heroHeadText:
      'font-black text-eerieBlack lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[90px] mt-1',
    heroSubText:
      'text-eerieBlack font-medium lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px]',
  
    sectionHeadText:
      'text-flashWhite font-black md:text-[60px] sm:text-[48px] xs:text-[40px] text-[30px] font-poppins',
